...
public class SPUtils {
     ...
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = "partycat_data";
    public static final String IS_SHOW_GUIDE = "is_show_guide";
    public static final String IS_SHOW_WRITE = "is_show_guide";
    /**
     * 查询键对应的值
     *
     * @param key
...
/**************************************** 以下为需要传入Context参数的API ******************************************/
   ...
   /* public static boolean isLogin(){
        return !get(Constant.TOKEN,"").equals("");
    }
    public static String getToken(){
        return get(Constant.TOKEN,"");
    }
    public static int getId(){
        return get(Constant.ID,0);
    }
    public static String getName(){
        return get(Constant.NAME,"");
    }
    public static Integer getLevel(){
        return get(Constant.LEVEL,0);
    }
    public static String getPic(){
        return get(Constant.PIC,"");
    }
    public static int getMoney(){
        return get(Constant.MONEY,0);
    }
    public static String getPhone(){
        return get(Constant.Phone,"");
    }*/
